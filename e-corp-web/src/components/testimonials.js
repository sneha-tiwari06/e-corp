    ...
    <div className="breadcrumb-container bg-purple w-100">
            <div className="pageHeading">
                <div className="row mx-0 align-items-center justify-content-between">
                    <div className=" col-md-6 col-sm-6 pageTitle"><h2 className="mb-0 text-ecis text-white">Testimonials</h2></div>
        ...
        <div className="w-100 padding testimonials-wrapper">
            <div className="container-fluid">
                <div className="heading-container text-center">
                    <div className="heading mx-auto mb-2 text-center">
                        ...
                        <h2>What Our <span className="text-red">Clients</span> Say About Us</h2>
                    </div>
                ...
                <div className="testimonials">
                    <div className="row gap-row">
                        <div className="col-md-6 testimonialBox">
                            <div className="inner">
                                <div className="testimonialText">
                                    <p className="mb-0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quod pariatur delectus adipisci placeat corrupti libero quos asperiores debitis eveniet reprehenderit, maxime quae laboriosam sed, vel atque, ut in veniam necessitatibus!</p>
                                </div>
                                <div className="testimName">
                                    <span className="verticle-line"></span>
                                    <h6 className="text-ecis">Smriti Seth</h6>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 testimonialBox">
